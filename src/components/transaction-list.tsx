...
import { formatCurrency, formatDate, centavosToReais } from "@/lib/format";
            ...
            <div className="flex items-center gap-1 opacity-0 group-hover:opacity-100 transition-opacity shrink-0">
              <button
                onClick={() =>
                  onEdit({
                    ...tx,
                    // Converte para o formato esperado pelo form
                  })
                }
                className="rounded-lg p-1.5 text-muted-foreground hover:text-foreground hover:bg-foreground/10 transition-all cursor-pointer"
                title="Editar"
              >
                <svg
                  className="h-4 w-4"
              ...
              <button
                onClick={() => onDelete(tx)}
                className="rounded-lg p-1.5 text-muted-foreground hover:text-destructive hover:bg-destructive/10 transition-all cursor-pointer"
                title="Excluir"
              >
                <svg
                  className="h-4 w-4"
